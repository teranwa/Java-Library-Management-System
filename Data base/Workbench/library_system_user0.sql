...
CREATE TABLE `user` (
  ...
  `u_mname` varchar(45) DEFAULT NULL,
  `u_lname` varchar(45) DEFAULT NULL,
  `u_gender` varchar(45) DEFAULT NULL,
  `u_bod` date DEFAULT NULL,
  `u_nicno` varchar(45) DEFAULT NULL,
  `u_address` varchar(45) DEFAULT NULL,
  `u_phoneno` varchar(45) DEFAULT NULL,
  `u_privilage` int(11) DEFAULT NULL,
...
INSERT INTO `user` VALUES (1,'Pasindu','Panthaka','Senavirathne','Male','1992-03-30','920781357v','frf,rfvfvvv,tevvev,vewvqv.','0710454108',1,'panthaka');
